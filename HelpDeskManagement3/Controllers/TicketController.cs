...
namespace HelpDeskManagement3.Controllers
{
    ...
    public class TicketController : Controller
    {
        ...
        {
            int statusId = 0;
            var openticketview = userData.TicketTables.Where(model => model.Status == statusId).FirstOrDefault();
        ...
        {
            int statusId = 2;
            var ticketview = userData.TicketTables.Where(model => model.Status == statusId).FirstOrDefault();
